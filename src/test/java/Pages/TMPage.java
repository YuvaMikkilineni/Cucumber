...
import static Utilities.Wait.WaitToBeVisible;
...
//
//        assertEquals(actualCode, "January2024-Yuva", "The Record Created Successfully");
    }

    public void AssertCreateTMRecord(WebDriver driver)
    {
        WaitToBeVisible(driver, "XPath", "//*[@id=\"tmsGrid\"]/div[4]/a[4]/span", 5);
        //Click on Last Page button
        goToLastPage = driver.findElement(By.xpath("//*[@id=\"tmsGrid\"]/div[4]/a[4]/span"));
        ...
        assertTrue("January2024-Yuva".equals(actualCode), "The Record Created Successfully");
    }
        ...
        try {
            ...
            for (int i = 1 ; i <= tmRecordPages ; i++) {
                ...
                for (int j = 1 ; j <= tmPageRows.size() ; j++) {
                    ...
                    if (firstNames.contains("January2024-Yuva")) {
                        ...
                        typeDropDown = driver.findElement(By.xpath("//*[@id=\"TimeMaterialEditForm\"]/div/div[1]/div/span[1]/span/span[2]/span"));
                        typeDropDown.click();
                        WaitToBeVisible(driver, "XPath", "//*[@id=\"TypeCode_listbox\"]/li[1]", 5);
...
//            assertNotEquals(actualCode, editCode.getText(), "The Record Updated Successfully");
    ...
    public void AssertEditedTimeRecord(WebDriver driver) throws InterruptedException {
...
//                assertFalse(actualCode.equals("January2024-Y"), "Record Deleted successfully");
    ...
    public void AssertDeletedTimeRecord(WebDriver driver) throws InterruptedException {
        ...
        assertFalse(actualCode.contains("January2024-Y"), "Record Deleted successfully");
